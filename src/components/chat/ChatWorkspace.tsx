...
type MessageAction = "open-dashboard" | "open-transactions" | "open-transfer" | "open-scheduled-transfers" | "open-subscriptions" | "open-cards" | "open-goals" | "open-budgets" | "open-bills" | "open-accounts" | "open-beneficiaries" | "open-notifications" | "open-disputes" | "open-reports" | "open-forecast";
...
export function ChatWorkspace({ onClose }: ChatWorkspaceProps) {
  ...
  const submit = (value?: string) => {
    ...
    else if (connectedAccountsRequested) reply = { role: "assistant", text: "Your connected accounts are ready. Review balances and account details, connect another bank, or remove a secondary account.", action: "open-accounts" };
