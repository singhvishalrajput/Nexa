...
- `fund`: after migration V21, post one idempotent, balanced capital deposit to bring the bank funding reserve to INR 1 crore. Cash is debited and the funding reserve credited. Existing customer balances are untouched.
