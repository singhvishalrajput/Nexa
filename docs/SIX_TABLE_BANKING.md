...
For the subsequent real payee-transfer fix, chat loan repayment, and dedicated administrator interface, see [Transfers and account administration](TRANSFERS_AND_ADMIN.md). Migration V19 extends the six-table schema with administrative audit fields and transfer cancellation; the original V16–V18 migration history remains unchanged.
