...
export function Overview({ token, name, accounts, reload }: {
 ...
 <Panel className="bank-next-step"><span class="bank-tile-symbol">✧</span><p class="bank-eyebrow">BANKING, MADE SIMPLE</p><h2>Start with a conversation.</h2><p>Type or speak to check your balance, see recent payments, or get help. English and Hindi voice available.</p><a class="bank-button" href="#/assistant">Ask Nexa <span>↗</span></a></Panel></div>
