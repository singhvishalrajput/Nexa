...
public record BankingContent(
    ...
    long totalElements,
    List<com.nexa.api.beans.BankingModels.Mandate> mandates,
    List<com.nexa.api.beans.BankingModels.Bill> bills,
    List<com.nexa.api.beans.BankingModels.Card> cards,
    List<com.nexa.api.beans.BankingModels.Beneficiary> beneficiaries,
    List<com.nexa.api.beans.BankingModels.Payment> payments,
    List<com.nexa.api.beans.BankingModels.Loan> loans,
    com.nexa.api.beans.BankingModels.PreparedAction action,
    com.nexa.api.beans.BankingModels.Transfer transfer,
    String responseType,
    String errorCode,
  ...
  public static BankingContent domain(String type, String responseType, Object data) {
    return new BankingContent(
        ...
        type.equals("ACTION_REQUIRED")
            ? (com.nexa.api.beans.BankingModels.PreparedAction) data
            : null,
        type.equals("TRANSFER_STATUS") ? (com.nexa.api.beans.BankingModels.Transfer) data : null,
        responseType,
        null,
        null);
  }
