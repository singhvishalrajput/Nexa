...
import com.nexa.api.service.UserQueryService.UserSummary;
...
public class CustomerQueryService {
  ...
  private final com.nexa.api.repository.CustomerDao customers;
  private final com.nexa.api.service.CustomerService customerService;
  ...
  CustomerQueryService(
      ...
      com.nexa.api.repository.CustomerDao customers,
      com.nexa.api.service.CustomerService customerService) {
  ...
  public CustomerProfileResponse updateCurrentProfile(UpdateProfileRequest request) {
    ...
    customers
        ...
        .ifPresent(
            customer -> {
              var input = new com.nexa.api.beans.Customer();
